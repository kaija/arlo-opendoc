...
// Maps search result IDs to note IDs used by the app
...
// ── Data (copied verbatim from screens/Search.tsx) ─────────────────────────
...
const FILTER_PILLS = ['All notebooks', 'Runbooks', 'Architecture Decisions', 'Incidents'];

// ── Sub-components (copied verbatim from screens/Search.tsx) ───────────────
...
// Blinking cursor matching design spec
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Esc badge — click to dismiss without selecting a note */}
          <span
            style={{
              background: '#f0f0f8',
        ...
        <div style={{ maxHeight: 420, overflowY: 'auto' }}>
          {RESULTS.map((result, i) => (
            <div
              ...
              onClick={() => onClose(NOTE_IDS[result.id])}
            >
              {/* Left: text content */}
